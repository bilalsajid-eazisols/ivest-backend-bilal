  ...
  (p.ClassBody = function () {
    ...
    (p.ClassNavMenu = function () {
      p.BreakClass("." + s, d.lg, { timeOut: 0 }),
        p.BreakClass("." + l, d.lg, { timeOut: 0, classAdd: t }),
        r.on("resize", function () {
          p.BreakClass("." + s, d.lg),
            p.BreakClass("." + l, d.lg, { classAdd: t });
        });
    }),
    (p.Prettify = function () {
    ...
    (p.Toast = function (e, t, n) {
      ...
      (n.position = n.position ? "toast-" + n.position : "toast-bottom-right"),
        ...
        "" !==
          (e =
            "" !== e ? i + '<div class="toastr-text">' + e + "</div>" : "") &&
        ...
        c.on("mouseup", function (e) {
          ...
          o &&
            ...
            t.is(e.target) ||
              ...
              (p.Toggle.removed(t.data("target"), s), (o = !1)));
        }),
        r.on("resize", function () {
          n.each(function () {
    ...
    (p.Custom.Stepper = function (n, e) {
      ...
      function y(e) {
        ...
        1 === t &&
          ...
          b &&
            ((o.innerHTML = "".concat(e, " of ").concat(h)),
      ...
      r.querySelector("button").addEventListener("click", function (e) {
        ...
        var e = k.form(),
          t = g - 1;
        e
          ? h !== g && (v && a[t].classList.add(p), i[t].classList.add(f))
          : (v && a[t].classList.remove(p), i[t].classList.remove(f)),
          y(--g);
      }),
